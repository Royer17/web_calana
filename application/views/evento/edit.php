        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?= form_open_multipart('evento/update', array('class'=>'form-horizontal')); ?>
            
              <div class="box-body">
                <div class="form-group" >
                  <div class="col-sm-2 control-label">
                    <?= form_label('ID', 'id_evento', array('class'=>'form-label')); ?>
                  </div>
                  
                  
                  <div class="col-sm-10">
                    <span class="uneditable-input"><?= $registro->id_evento ;?></span>
                    <?= form_hidden('id_evento', $registro->id_evento); ?>
                  </div>
                </div>
                <div class="form-group">
                  <label for="Titulo" class="col-sm-2 control-label" >Titulo</label>
                  <div class="col-sm-10">
                    <input type="text" name="titulo_evento" class="form-control" id="titulo_evento" value="<?= $registro->titulo_evento; ?>">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <img  class="img-thumbnail" src=<?= base_url('img/eventorPrincipal/'.$registro->img_evento ); ?> alt="foto"  style="width:300px">
                    <?= form_input(array('type'=>'file','name'=>'img_evento','id'=>'img_evento','value'=>$registro->img_evento)); ?>
                  </div>
                </div>
