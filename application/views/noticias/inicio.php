          <?php foreach ($query as $registro): ?>
            <div class="row noticia">
              ...
              <div class="col s12 m4">
                <img class="responsive-img z-depth-1 hoverable materialboxed" src=<?= base_url('img/noticia/'.$registro->foto ); ?> alt="">
              </div>
              <div class="col s12 m8">
                <p class="fecha"><i class="icon-calendar"></i><?= $registro->dt_fecha_informacion ?></p>
