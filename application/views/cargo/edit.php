<?= form_open('cargo/update', array('class'=>'form-horizontal')); ?>
	...
	<div class="form-actions">
		...
		<?= anchor('cargo/delete/'.$registro->id , 'Eliminar', array('class'=>'btn btn-warning','onClick'=>"return confirm('¿Está Seguro?')")); ?>	
	</div>
<?= form_close(); ?>
