							...
							<table border="0" width="600" cellspacing="0" cellpadding="0">
								...
								<tr>
									<td valign="top">
													...
													<font color="#2D2D2D" face="Calibri" size="2">LA 
													LICENCIA DE FUNCIONAMIENTO ES LA AUTORIZACION 
													QUE OTORGA LA MUNICIPALIDAD DISTRITAL DE CIUDAD 
													NUEVA, PARA EL DESARROLLO DE LAS ACTIVIDADES 
													ECONOMICAS, A FAVOR DEL SOLICITANTE, ASIMISMO, 
													LA COMUNA DISTRITAL CONTRIBUYE CON EL 
													ORDENAMIENTO DE NEGOCIOS</font></p>
													<p class="MsoNormal" style="background: rgb(0, 139, 139)">
													<span style="font-size: 9pt; font-family: Calibri; color: #FFFFFF; font-weight: 700">
													&nbsp;
													FORMULARIOS</span></p>
													<table border="0" width="86%" cellspacing="3" cellpadding="2">
														<tr>
															<td width="27">
													...
													&nbsp;
													LEGISLACION</span></p>
													<table border="0" width="78%" cellspacing="3" cellpadding="2">
														<tr>
															<td>
															<img border="0" src="<?= base_url('img/pdf.png') ?>" width="30" height="29"></td>
															<td width="816">
													...
													<table border="0" width="82%" cellspacing="3" cellpadding="2">
														<tr>
															<td width="27">
															<img border="0" src="<?= base_url('img/pdf.png') ?>" width="30" height="29"></td>
															<td>
