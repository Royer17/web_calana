...
<link href="<?= base_url('') ?>plugins/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
...
<script src="<?= base_url('') ?>plugins/js/jquery-1.11.1.min.js"></script>
...
<script src="<?= base_url('') ?>plugins/js/funcionesJquery.js"></script>
      ...
      <div class="modal-body">
          ...
          <span aria-hidden="true">&times;</span>
               ...
               <?php foreach ($query10 as $index =>$file10 ): ?>
                ...
                <a href=<?= base_url('popup/detalle/'.$file10->id_popup ); ?> >
              
                  <img src="<?= base_url('img/popup/'.$file10->img_popup); ?>" class="img-rounded" alt="Cinque Terre" width="470" height="600" />   </div>
  ...
  <header id="header-wrapper">
    ...
    <section id="header_menu" class="efecto"><div class="wrapper">
        ...
        <ul id='list_prin'>
          ...
          <li><a href='#' class='mnu_pri '>Servicios Municipales <i class='fa fa-angle-down' aria-hidden='true'></i></a><ul class='list_sec' style='width:207px;'>
